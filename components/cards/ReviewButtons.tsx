...
const ReviewButtons: React.FC<ReviewButtonsProps> = ({
  ...
  const getImage = (rating: any) => {
    return selectedRating === rating
      ? require("../../assets/doctors/whitestar.png")
      : require("../../assets/doctors/astar.png");
  };
  return (
    <View style={styles.btns}>
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
        ...
        >
          <Text style={getButtonTextStyle("all")}>
            <Image source={getImage("all")} style={styles.images} /> All
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={getButtonTextStyle(5)}>
            <Image source={getImage(5)} style={styles.images} />5
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={getButtonStyle(4)}
          onPress={() => handleRatingSelect(4)}
        >
          <Text style={getButtonTextStyle(4)}>
            <Image source={getImage(4)} style={styles.images} /> 4
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={getButtonTextStyle(3)}>
            {" "}
            <Image source={getImage(3)} style={styles.images} /> 3
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={getButtonTextStyle(2)}>
            {" "}
            <Image source={getImage(2)} style={styles.images} /> 2
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={getButtonTextStyle(1)}>
            {" "}
            <Image source={getImage(1)} style={styles.images} /> 1
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
