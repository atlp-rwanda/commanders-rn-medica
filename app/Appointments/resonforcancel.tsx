...
function ReschedulApointment() {
  ...
  const { appointment_date, appointment_time, appointmentId,doctimage,doctorname,typecall} = useGlobalSearchParams<{ appointment_date: any, appointment_time: any, appointmentId: string,doctimage:any,doctorname:string,typecall:any }>();
