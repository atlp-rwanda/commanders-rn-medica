          ...
          {cancels && (
            ...
            {canceledData.map((canceled,index)=>(
              <Cardcomponent
                 ...
                 time={canceled.appointment_time}
          ...
          <View className="bg-white w-full rounded-t-3xl p-5 flex justify-center items-center">
            ...
            <View className="flex flex-row w-11/12 justify-between items-center  pt-3">
              <TouchableOpacity onPress={() => setIsModalVisible(false)}>
                <View className=" rounded-3xl pb-3 pt-3 pl-14 pr-14 bg-slate-200">
                  <Text className="text-black text-center font-UrbanistBold text-[16px]">
                    No
                  </Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                  ...
                  router.push({
                    pathname: "/Appointments/resonforcancel",
                    params: appointId,
                  });
                }}
              >
                <View className=" rounded-3xl pb-3 pt-3 pl-14 pr-14 bg-primary-500 ">
                  <Text className="text-white text-center font-UrbanistBold text-[16px]">
                    Yes, Cancel
                  </Text>
                </View>
              </TouchableOpacity>
